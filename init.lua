...
Kickstart Guide:
  ...
  Next, run AND READ `:help`.
    ...
    MOST IMPORTANTLY, we provide a keymap "<space>f?" to [f]ind the [?] help documentation,
...
require('lazy').setup {
  ...
  -- Auto-reloading on plugin change isn't super helpful, gotta restart nvim anyway.
  change_detection = {
    enabled = false,
  },
}
